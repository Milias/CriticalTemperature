...
#print('v2: %f' % (time.time() - t0))

#t0 = time.time()
#print(fluct_2d_n_sc(chi_ex, mu_e, mu_h, sys))
#print('v1: %f' % (time.time() - t0))

t0 = time.time()
print(fluct_2d_mu(1, sys))
...
#x1 = E - mu_t + chi_ex * linspace(16, global_eps, N)
#x2 = linspace(global_eps, 16, N)
