...
if file_version == 'v2':
    ...
    fit_vars_label = 'fit_vars_model_biexc_v2'
    n_x, n_y = 4, 3
...
def TA_model(abs_data, ta_srt_dict, pump_case, steady_data):
    ...
    def model_fun(xdata, *popt, return_dict=False):
        ...
        se_hh_data /= trapz(se_hh_data, xdata)
        se_lh_data /= trapz(se_lh_data, xdata)
        ...
        result = clip(
            abs_interp - depl_data - depl2_data - se_hh_data - se_lh_data +
            hhhh,
            0,
            1,
        )
